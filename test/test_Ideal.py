...
class TestIdealMethodsConsistency():
    ...
    def test_max_motive_position_at_emitter(self, valid_emitter_args, valid_collector_args):
        collector = tec.electrode.Metal(**valid_collector_args)
        ...
        assert ideal_model.emitter.motive() > ideal_model.collector.motive()
        assert ideal_model.max_motive_position == ideal_model.emitter.position


    def test_max_motive_position_at_collector(self, valid_emitter_args, valid_collector_args):
        emitter = tec.electrode.Metal(**valid_emitter_args)
        ...
        assert ideal_model.collector.motive() > ideal_model.emitter.motive()
        assert ideal_model.max_motive_position == ideal_model.collector.position
