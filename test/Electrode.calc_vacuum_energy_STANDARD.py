...
vacuum_energy = electron_charge * (voltage + barrier_ht - nea)
vacuum_energy
#[Out]# 0.0
params = {"voltage":voltage, "barrier_ht":barrier_ht, "nea":nea, "vacuum_energy":vacuum_energy}
std.append(params)
