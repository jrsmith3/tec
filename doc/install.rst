...
Zip file install
................
All you have to do is download the most recent version (0.3.0) from the internet `here <https://github.com/jrsmith3/tec/archive/0.3.0.zip>`_. Unzip the file and switch into the directory into which the zip file was uncompressed. Then execute the following command at the command line.
