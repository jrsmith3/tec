...
class DimensionlessLangmuirPoissonSoln():
  """
  ...
  def __init__(self):
    ...
    self["lhs"] = calc_branch(-2.5538)
    self["rhs"] = calc_branch(100)
  ...
  def calc_branch(self, endpoint, num_points = 1000):
    ...
    motive_v_position = \
      interpolate.InterpolatedUnivariateSpline(position_array,motive_array)
    position_v_motive = \
      interpolate.InterpolatedUnivariateSpline(motive_array,position_array)
